...
import { getOrderHistoryDeliverer } from '../../services/orderService';

const OrderHistoryDeliverer = () => {
    ...
    useEffect(() => {
        const fetchOrderHistory = async () => {
            try {
                const data = await getOrderHistoryDeliverer();
...
export default OrderHistoryDeliverer;
